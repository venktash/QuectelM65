 ...
 *   Operation:
 *            
 *     If input "Reset=<type>", that will reset the module.
 *     If input "Sleep=<msec> ", that will suspends the execution of the current
 *     task until the time-out interval elapses.
 *     If input "Get Core Version", that will get the version ID of the core.
 *     If input "Get SDK Version", that will get the version ID of the SDK.
 *     If input "Get Ms Since PwrOn", that will get the number of milliseconds since
 *     the device booted.
 *
 * Author:
 * -------
